...
import org.onap.integration.simulators.nfsimulator.vesclient.template.search.TemplateSearchHelper;
...
class TemplateServiceTest {
    ...
    void testShouldReturnAllTemplates() {
        ...
        Assertions.assertThat(actual).containsExactly(SAMPLE_TEMPLATE_LIST.get(0));
    }
