...
package org.onap.integration.simulators.nfsimulator.vesclient.filesystem;
...
class WatcherEventProcessorTest {
    ...
    @BeforeAll
    static void init() {
        jsonFilePath = Paths.get("src/test/resources/org/onap/integration/simulators/nfsimulator/vesclient/simulator/filesystem/test1.json");
    }
